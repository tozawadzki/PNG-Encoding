...
import crypting,keys,rabinMiller
...
def getIDAT(filename):
    ...
    IDAT_compress = IDAT_data
    #print(IDAT_data)
    IDAT_data = zlib.decompress(IDAT_data)
    IDAT_decompress = IDAT_data
   # print(IDAT_data)
    ###########################################################
   ...
   # print(Recon)
    return Recon,IDAT_compress,IDAT_decompress,height,width
